...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const start = async () => {
    ...
    const Anchor0 = mindarThree.addAnchor(0);
		...
		window.location.href = "./pages/page1.html"; // Redirect to page 1
    ...
    const Anchor1 = mindarThree.addAnchor(1);
		...
		window.location.href = "./pages/page2.html"; // Redirect to page 2
        //window.open('https://www.mindar.org/', '_self'); 
	};
	...
	const Anchor2 = mindarThree.addAnchor(2);
		...
		window.location.href = './pages/page3.html'; // Redirect to page 3
        //window.open('https://www.mindar.org/', '_self'); 
    };
